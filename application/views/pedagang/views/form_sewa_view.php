        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= form_open_multipart('pedagang/sewa/insert', ['class' => 'form-horizontal']) ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_penyewa" placeholder="Masukkan Nama Lengkap" value="<?= $this->session->userdata('nama') ?>" readonly>
                                   <!-- <input type="hidden" name="id_penyewa" value="<?= $item['id'] ?>" > -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                <?php
                                    // Menghasilkan tanggal 1 dari bulan dan tahun saat ini (format YYYY-MM-DD)
                                    $tanggalOtomatis = date('Y-m-d');
                                ?>
                                <input type="date" class="form-control" name="tanggal_mulai_sewa" value="<?= $tanggalOtomatis ?>" readonly>
                                <?php // form_error tidak lagi terlalu relevan karena nilai sudah pasti, tapi bisa dipertahankan ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="harga"  value="<?= $kios ->hKios; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="foto_ktp_ahli_waris" class="col-sm-2 control-label">Foto KTP</label>
                                <div class="col-sm-10">
                        ...
                        <div class="box-footer">
                            <a href="<?= base_url('pedagang/pasarbaru') ?>" class="btn btn-default">Batal</a>

            ...
            <div class="col-md-3">
                <div class="box">
                    <div class="box-body box-profile">
                        ...
                        <a href="<?= base_url('pedagang/profil/nonaktif/').$this->session->userdata('id') ?>" class="btn btn-warning btn-block tombol-yakin" data-isidata="Akun akan dinonaktifkan">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="account">
                            <form class="form-horizontal" action="<?= base_url('pedagang/profil/updateaccount/').$this->session->userdata('id') ?>" method="POST">
                        ...
                        <div class="tab-pane" id="foto">
                            <form class="form-horizontal" action="<?= base_url('pedagang/profil/updatefoto/').$this->session->userdata('id') ?>" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                                <div class="box-body">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" id="password">
                            <form class="form-horizontal" action="<?= base_url('pedagang/profil/updatepassword/').$this->session->userdata('id') ?>" method="POST">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                                <div class="box-body">
                                    <div class="form-group">

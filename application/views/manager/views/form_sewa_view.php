<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('manager/views/pasarbaru') ?>">Denah Kios</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= form_open_multipart('manager/views/sewa/insert', ['class' => 'form-horizontal']) ?>
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a href="<?= base_url('manager/views/pasarbaru') ?>" class="btn btn-default">Batal</a>

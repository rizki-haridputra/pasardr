<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
          <form class="form-horizontal" action="<?= base_url('manager/views/aplikasi/update/').$row['id'] ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if($row['logo'] != '') { ?>
                    ...
                    <br>
                    <a href="<?= base_url('manager/views/aplikasi/delete_logo/').$row['id'] ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Ingin menghapus logo?">

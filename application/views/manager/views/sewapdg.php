                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('manager/views/angsuran/pembayaran/').$row['id'] ?>" class="btn btn-success btn-xs">
                                        ...
                                        <?php if($this->session->userdata('level') == 'manager') { ?>
                                            ...
                                            <?php if($statusText == 'Kurang Bayar') { // Kondisi disesuaikan dengan status otomatis ?>
                                                <a href="<?= base_url('manager/views/Sewa/delete/').$row['id'] ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Ingin menghapus data ini?">
...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('manager/views/Sewa/insert') ?>" method="POST">
    ...
    <div class="modal fade" id="editData<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('manager/views/Sewa/update/').$edit->id ?>" method="POST">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nasabah</label>

	...
	<div class="box">
            <div class="box-body">
                <?php if($this->session->userdata('level') == 'Petugas') { ?>
					...
					<a href="<?= base_url('petugas/lantaisatu') ?>" class="btn btn-app">
                        <span class="badge bg-<?= $this->session->userdata('skin') ?>"><?= $this->db->where('level', 'pedagang')->get('tb_user')->num_rows() ?></span>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($this->session->userdata('level') == 'Petugas'OR $this->session->userdata('level') == 'Petugas') { ?>
...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('petugas/kios/insert') ?>" method="POST">
    ...
    <div class="modal fade" id="editData<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('petugas/kios/update/').$edit->idKios ?>" method="POST">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                    <div class="modal-body">
                       <div class="form-group">
                        <label>Id Kios</label>

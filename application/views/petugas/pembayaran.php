                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    <?php
                                        // Menentukan status berdasarkan sisa pembayaran
                                        if ($sisaPembayaran <= 0) {
                                            $status = 'Lunas';
                                            $labelClass = 'success';
                                        } else {
                ...
                <div class="box">
                    <?php if ($this->session->userdata('level') == 'Petugas') { ?>
                        <div class="box-header">
                            ...
                            <?php endif; ?>
                            <a href="<?= base_url('petugas/angsuran/cetakpembayaran/') . $idSewa ?>" class="btn btn-warning" target="blank">
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($this->session->userdata('level') == 'Petugas') { ?>
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('petugas/angsuran/delete/') . $ang->id . '/' . $idSewa ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Ingin menghapus data ini?">
...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('petugas/angsuran/insert/') . $idSewa ?>" method="POST">
    ...
    <div class="modal fade" id="editData<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('petugas/angsuran/update/') . $idSewa . '/' . $edit->id ?>" method="POST">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" style="display: none">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Tanggal</label>

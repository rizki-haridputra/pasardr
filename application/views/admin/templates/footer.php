<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2025 - <?= date('Y') ?> <a href="https://google.com" target="blank">Elnur Firdaus</a>.</strong> All rights reserved.
</footer>
...
<script>
  ...
  const flashDataPerbaharui = $('.flash-data-perbaharui').data('flashdataperbaharui');
  if (flashDataPerbaharui){
    iziToast.warning({
      title: ' ',
      message: flashDataPerbaharui,
      position: 'topRight',
    });
  }

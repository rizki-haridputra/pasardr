        ...
        <div class="box">
            <div class="box-body">
                <?php if($this->session->userdata('level') == 'Administrator') { ?>
                    ...
                    <a href="<?= base_url('admin/verifikasi') ?>" class="btn btn-app">
            ...
            <div class="row">
                    ...
                    <div class="small-box bg-red">
                        ...
                        <div class="icon">
                            <div class="fa fa-money"></div>
                                    ...
                                    <a href="<?= base_url('admin/laporan_pendapatan/') ?>" class="small-box-footer">
                    ...
                    <div class="small-box bg-blue">
                        ...
                        <div class="icon">
                            <div class="fa fa-level-up"></div>
                                ...
                                <a href="<?= base_url('admin/laporan/') ?>" class="small-box-footer">
                        <!-- <a href="<?= base_url('admin/angsuran') ?>" class="small-box-footer"> -->
                            More info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="small-box bg-green">
                        ...
                        <a href="<?= base_url('admin/validasi') ?>" class="small-box-footer">
                        <!-- <a href="<?= base_url('admin/angsuran') ?>" class="small-box-footer"> -->
                            More info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="small-box bg-green">
                        <div class="inner">
                            ...
                            <p>Belum Validasi<?= date('Y') ?></p>
                        </div>
                        <div class="icon">
                            <div class="fa fa-calendar"></div>
                        </div>
                        <a href="<?= base_url('admin/validasis') ?>" class="small-box-footer">
                        <!-- <a href="<?= base_url('admin/angsuran') ?>" class="small-box-footer"> -->
                            More info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>

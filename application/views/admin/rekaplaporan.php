                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $this->db->where('id', $this->db->where('id', $ang->idSewa)->get('tb_sewa')->row('nama'))->get('tb_user')->row('nama') ?></td>
                                <!-- <td><?= $this->db->where('id', $this->db->where('id', $ang->idSewa)->get('tb_angsuran')->row('idPedagang'))->get('tb_user')->row('telp') ?></td> -->

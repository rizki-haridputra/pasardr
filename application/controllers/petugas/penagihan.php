...
class penagihan extends CI_Controller {
	...
	public function index()
	{
		...
		$data['sewa']		= $this->db->get_where('tb_sewa', ['StatusSewa' => 'validasi']);
	...
	public function form($id)
	{
		...
		if($this->session->userdata('level') == 'Pedagang') {
			$this->db->where('Pedagang', $this->session->userdata('id'));
		}
		...
		$this->load->view('petugas/templates/header', $data);
		$this->load->view('petugas/templates/sidebar');
		$this->load->view('petugas/form_sewa_view', $data);
		$this->load->view('petugas/templates/footer');
    }

...
class Angsuran extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('manager/views/angsuran');
	...
	public function search()
	{
		...
		redirect("manager/views/angsuran/pembayaran/$idSewa");
	}
	...
	public function pembayaran($idSewa)
	{
		...
		$this->load->view('manager/templates/header', $data);
		$this->load->view('manager/templates/sidebar');
		$this->load->view('manager/views/pembayaran');
		$this->load->view('manager/templates/footer');
	}
	...
	public function cetakpembayaran($idSewa)
	{
		...
		$this->load->view('manager/views/cetakpembayaran', $data);
	}
}
...
<script src="<?= base_url('assets') ?>/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
				...
				<div class="modal fade" id="modalRegister" tabindex="-1" role="dialog" aria-labelledby="modalRegisterLabel">
					  <div class="modal-dialog" role="document">
						<div class="modal-content">
						  <form action="<?= base_url('home/daftar_aksi') ?>" method="POST" enctype="multipart/form-data">
							<div class="modal-header">
							  <h4 class="modal-title" id="modalRegisterLabel">Form Pendaftaran</h4>
							</div>
							<div class="modal-body">
							  <!-- Tambahkan input sama seperti di register.php -->
							  <div class="form-group">
							  ...
							  <div class="form-group">
								<label><?= $captcha ?></label>
								<input type="text" class="form-control" name="jawaban" placeholder="Hitung dan isi hasilnya" required>
							  </div>
							</div>
    ...
    <a href="#" data-toggle="modal" data-target="#modalRegister">Belum punya akun? Daftar di sini</a>
</div>
            </div>
        </div>

                                ...
                                <tr>
                                    ...
                                    <td>Rp. 
                                        <?php
                                            ...
                                            foreach ($this->db->get('tb_angsuran')->result() as $tAng) {
                                                echo number_format($tAng->nominal,0,',','.');
                                            }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/angsuran/pembayaran/').$row['id'] ?>" class="btn btn-success btn-xs">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="idPedagang" class="select2" style="width: 100%" required>
                            <option value="" disabled selected> -- Pilih Pedagang -- </option>
                            <?php foreach ($pedagang->result() as $iNsb) { ?>
    ...
    <div class="modal fade" id="editData<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/Sewa/update/').$edit->id ?>" method="POST">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Pedagang</label>
                            <select name="idPedagang" class="select2" style="width: 100%" required>
                                ...
                                <?php } ?>
                                <option value="" disabled> -- Pilih Pedagang Lain -- </option>
                                <?php foreach ($pedagang->result() as $iNsb) { ?>
                                    <option value="<?= $iNsb->id ?>"><?= $iNsb->nama . ' - ' . $iNsb->jenisKelamin . ' - ' . $iNsb->telp ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" required>
                                ...
                                <option value="Belum Lunas" <?= ($edit->status == 'Belum Lunas') ? 'selected' : '' ?>>Belum Lunas</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">

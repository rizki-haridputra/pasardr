<footer class="main-footer">
    <div class="pull-right hidden-xs">
        <b>Version</b> 1.0.1 | Page rendered in <strong>{elapsed_time}</strong> seconds.
    </div>
    <strong>Copyright &copy; - <?= date('Y') ?> <a href="https://" target="blank">Elnur Firdaus</a>.</strong> All rights reserved.
</footer>

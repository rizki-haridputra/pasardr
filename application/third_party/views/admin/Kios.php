...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kios/insert') ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="hKios" class="form-control" placeholder="Harga Sewa" required>
                    </div>
                    <div class="form-group">
                        <label>Gambar</label>
                    ...
                    <div class="form-group">
                        <label>Penyewa</label>
                        <input type="text" name="penyewa" class="form-control" placeholder="Penyewa" required>
                    </div>
                </div>
    ...
    <div class="modal fade" id="editData<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/kios/update/').$edit->idKios ?>" method="POST">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                    <div class="modal-body">
                       <div class="form-group">
                        <label>Id Kios</label>
                    ...
                    <div class="form-group">
                        <label>Harga Sewa</label>
                        <input type="number" name="hKios" class="form-control" placeholder="Harga Sewa" value="<?= $edit->hKios ?> " required>
                    </div>
                    <div class="form-group">
                        <label>Gambar</label>
                    ...
                    <div class="form-group">
                        <label>Penyewa</label>
                        <input type="text" name="penyewa" class="form-control" placeholder="Penyewa" value="<?= $edit->penyewa ?> " required>
                    </div>
                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-danger"><div class="fa fa-trash"></div> Reset</button>
